        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">Create New Document_metum</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/admin/document_meta', 'class' => 'form-horizontal', 'files' => true]) !!}

                                    <div class="form-group {{ $errors->has('document_id') ? 'has-error' : ''}}">
                {!! Form::label('document_id', 'Document Id', ['class' => 'col-md-4 control-label']) !!}
                <div class="col-md-6">
